...
from fortishield_testing.tools.services import check_if_process_is_running


def check_if_modulesd_is_running():
    """Check if modulesd daemon is running"""
    assert check_if_process_is_running('fortishield-modulesd'), 'fortishield-modulesd is not running. It may have crashed'
