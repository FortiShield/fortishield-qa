...
from fortishield_testing.tools.monitoring import Queue
...
class RemotedSimulator:
    ...
    def __init__(self, server_address='127.0.0.1', remoted_port=1514, protocol='udp', mode='REJECT',
                 client_keys=FORTISHIELD_PATH + '/etc/client.keys', start_on_init=True, rcv_msg_limit=0):
    ...
    def fortishield_padding(self, compressed_sec_message):
        """Add the Fortishield custom padding to each sec_message sent."""
        padding = 8
    ...
    def create_sec_message(self, message, crypto_method, binary_data=None):
        ...
        # Padding
        padded_sec_message = self.fortishield_padding(compressed_sec_message)
        # Encrypt
