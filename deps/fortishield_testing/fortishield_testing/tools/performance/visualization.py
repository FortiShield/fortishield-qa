...
class DataVisualizer:
    """Class that allows to visualize the data collected using the fortishield_metrics tool.
    ...
    def _plot_analysisd_dataset(self):
        """Function to plot the statistics from fortishield-analysisd."""
    ...
    def _plot_remoted_dataset(self):
        """Function to plot the statistics from fortishield-remoted."""
    ...
    def _plot_agentd_dataset(self):
        """Function to plot the statistics from fortishield-agentd."""
    ...
    def _get_daemons(self):
        """Get the list of Fortishield Daemons in the dataset."""
