...
import fortishield_testing
from fortishield_testing.db_interface import global_db
from fortishield_testing.db_interface import agent_db
from fortishield_testing.tools.services import control_service
from fortishield_testing.tools import client_keys
...
SYSTEM_DATA = {
    ...
    'ALAS': {'hostname': 'amz', 'architecture': 'x86_64', 'os_name': 'Amazon Linux AMI', 'os_version': '2018.03',
             ...
             'version': 'Fortishield v4.3.0', 'os_release': '', 'checksum': '1645433796303855540', 'os_display_version': '',
    ...
    'ALAS2': {'hostname': 'alas2', 'architecture': 'x86_64', 'os_name': 'Amazon Linux', 'os_version': '2',
              ...
              'sysname': 'Linux', 'release': '4.14.198-152.320.amzn2.x86_64', 'version': 'Fortishield v4.3.0',
    ...
    'ALAS_2022': {'hostname': 'alas2022', 'architecture': 'x86_64', 'os_name': 'Amazon Linux', 'os_version': '2022',
                  ...
                  'version': 'Fortishield v4.4.0', 'os_release': '', 'checksum': '1645538649327530789', 'name': 'alas2022',
    ...
    'ALAS_2023': {'hostname': 'alas2023', 'architecture': 'x86_64', 'os_name': 'Amazon Linux', 'os_version': '2023',
                  ...
                  'version': 'Fortishield v4.4.0', 'os_release': '', 'checksum': '1693284466493410477', 'name': 'alas2023',
                  'ip': '127.0.0.1', 'register_ip': '127.0.0.1', 'internal_key': '', 'os_arch': 'x86_64',
    ...
    'FOCAL': {'hostname': 'focal', 'architecture': 'x86_64', 'os_name': 'Ubuntu', 'os_version': '20.04.3 LTS',
              ...
              'os_platform': 'ubuntu', 'sysname': 'Linux', 'release': '5.4.0-99-generic', 'version': 'Fortishield v4.3.0',
    ...
    'BOOKWORM': {'hostname': 'bookworm', 'architecture': 'x86_64', 'os_name': 'Debian GNU/Linux', 'os_version': '12',
                 ...
                 'os_platform': 'debian', 'sysname': 'Linux', 'release': '6.1.0-10-amd64', 'version': 'Fortishield v4.5.0',
    ...
    'BULLSEYE': {'hostname': 'bullseye', 'architecture': 'x86_64', 'os_name': 'Debian GNU/Linux', 'os_version': '11',
                 ...
                 'os_platform': 'debian', 'sysname': 'Linux', 'release': '5.10.0-10-amd64', 'version': 'Fortishield v4.3.0',
    ...
    'SLES15': {'hostname': 'localhost', 'architecture': 'x64', 'os_name': 'SLES', 'os_version': '15.2',
               ...
               'os_platform': 'sles', 'sysname': 'Linux', 'release': '5.3.18-22-default', 'version': 'Fortishield v4.4.0',
    ...
    'AlmaLinux-8': {'hostname': 'localhost', 'architecture': 'x64', 'os_name': 'AlmaLinux', 'os_version': '8',
                    ...
                    'version': 'Fortishield v4.4.0', 'os_release': '', 'checksum': '1652388661375945607',
...
def create_mocked_agent(name='centos8-agent', ip='127.0.0.1', register_ip='127.0.0.1', internal_key='',
                        ...
                        os_uname='x64', os_arch='x64', version='Fortishield v4.3.0', config_sum='', merged_sum='',
    ...
    # Restart Fortishield-DB before creating new DB
    control_service('restart', daemon='fortishield-db')
...
def delete_mocked_agent(agent_id):
    ...
    remove_file(os.path.join(fortishield_testing.QUEUE_DB_PATH, f"{agent_id}.db"))
