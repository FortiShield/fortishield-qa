...
from fortishield_testing import T_10, T_60
from fortishield_testing.modules.analysisd import ANALYSISD_PREFIX, MAILD_PREFIX, TESTRULE_PREFIX
from fortishield_testing import LOG_FILE_PATH, ANALYSISD_STATE
...
def get_analysisd_state():
    """Get the states values of fortishield-analysisd.state file
