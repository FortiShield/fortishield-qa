...
# Yaml Configuration
YAML_CONF_REGISTRY_RESPONSE = 'fortishield_conf_registry_responses_win32.yaml'
YAML_CONF_SYNC_WIN32 = 'fortishield_sync_conf_win32.yaml'
YAML_CONF_MAX_EPS_SYNC = 'fortishield_sync_conf_max_eps.yaml'
