...
from fortishield_testing.modules.aws import VPC_FLOW_TYPE
from fortishield_testing.modules.aws.cli_utils import analyze_command_output

PARSER_ERROR = r'.*wm_aws_read\(\): ERROR:.*'
MODULE_ERROR = r'.*wm_aws_run_s3\(\): ERROR: .*'
AWS_EVENT_HEADER = b'1:Fortishield-AWS:'
