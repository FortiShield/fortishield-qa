...
It utilizes the Fortishield testing framework, including the HostManager class for handling
...
from fortishield_testing.end_to_end.waiters import wait_syscollector_and_vuln_scan
from fortishield_testing.tools.system import HostManager
from fortishield_testing.end_to_end.vulnerability_detector import check_vuln_alert_indexer, check_vuln_state_index, \
...
def check_vulnerability_alerts(results: Dict, check_data: Dict, current_datetime: str, host_manager: HostManager,
    ...
    vulnerability_index = get_indexer_values(host_manager, index='fortishield-states-vulnerabilities',
