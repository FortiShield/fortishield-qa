"""
Fortishield API Methods Module.
-------------------------

This module provides functions for interacting with the Fortishield API, including retrieving API parameters, obtaining an API token for authentication, and fetching information about Fortishield agents and their vulnerabilities.

Functions:
    - get_api_parameters: Retrieves the Fortishield API parameters.
    - get_api_token: Retrieves the API token for authentication.
    - get_agents_id: Retrieves the IDs of Fortishield agents.
...
from fortishield_testing.api import make_api_call, get_token_login_api


# Fortishield API Methods
def get_api_parameters(host_manager):
    """
    Retrieves the Fortishield API parameters.

    Parameters:
    - host_manager (HostManager): An instance of the HostManager class.

    Returns:
    dict: A dictionary containing Fortishield API parameters, including protocol, host, port, user, and password.
    """
...
def get_agents_id(host_manager):
    """
    Retrieves the IDs of Fortishield agents.
...
def get_agents_vulnerabilities(host_manager):
    """
    Retrieves vulnerability information for Fortishield agents.
