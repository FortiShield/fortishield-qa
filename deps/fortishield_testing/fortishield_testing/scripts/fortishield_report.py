...
from fortishield_testing.tools.sources.report_generator import ReportGenerator


def get_script_arguments():
    parser = argparse.ArgumentParser(usage="%(prog)s [options]", description='Fortishield data sources generator',
