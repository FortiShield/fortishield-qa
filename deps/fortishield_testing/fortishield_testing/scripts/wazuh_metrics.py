...
from fortishield_testing.tools.performance.binary import Monitor, logger
...
def get_script_arguments():
    parser = argparse.ArgumentParser(usage="%(prog)s [options]", description="Fortishield processes metrics",
...
def main():
    ...
    logging.basicConfig(filename=join(METRICS_FOLDER, 'fortishield-metrics.log'), filemode='a',
