...
"""
Version: 1.0
Tool documentation: https://github.com/fortishield/fortishield-qa/wiki/Stress-results-comparator-tool
...
MANAGER_DAEMON_LIST = ['remoted', 'analysisd', 'fortishield-db', 'fortishield-authd', 'clusterd', 'monitord',
...
def process_dataframes(parameters):
    ...
    filtered_dataframes = [dataframe[dataframe['Daemon'] == f"fortishield-{parameters.selected_daemon}"] for dataframe
                           in dataframes]
