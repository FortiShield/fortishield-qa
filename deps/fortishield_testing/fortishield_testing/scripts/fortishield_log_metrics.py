...
from fortishield_testing.tools.performance.binary import ClusterLogParser, APILogParser
...
def get_script_arguments():
    ...
    parser = argparse.ArgumentParser(usage="%(prog)s [options]", description="Fortishield log parser",
