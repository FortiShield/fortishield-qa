...
def qa_docs_docker_run(qa_branch, command, output_path):
    ...
    Having this functionality helps the people that do not have ElasticSearch and(or) fortishield framework to generate
    the documentation of the tests.

    Args:
        qa_branch (str): Fortishield qa branch that will be used as tests input.
    ...
    docker_image_name = 'fortishield/qa-docs'
