...
class Config():
    ...
    https://github.com/fortishield/fortishield-qa/wiki/Documenting-tests-using-the-qadocs-schema#schema-blocks
    ...
    def __get_test_types(self):
        """Get all the test types within fortishield-qa framework."""
