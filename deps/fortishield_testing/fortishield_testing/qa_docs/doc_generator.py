...
from fortishield_testing.qa_docs.lib.config import Mode
from fortishield_testing.qa_docs.lib.code_parser import CodeParser
from fortishield_testing.qa_docs.lib.utils import clean_folder
from fortishield_testing.qa_docs import QADOCS_LOGGER
from fortishield_testing.tools.logging import Logging
from fortishield_testing.tools.exceptions import QAValueError
from fortishield_testing.qa_docs.lib.utils import get_file_path_recursively
...
class DocGenerator:
    ...
    The included paths are generated using the types and modules from the fortishield-qa framework.
    ...
    def print_module_info(self, module):
        ...
        """
        relative_path = re.sub(r'.*fortishield-qa\/', '', self.module_path)
