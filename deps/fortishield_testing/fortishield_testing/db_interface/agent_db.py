...
from fortishield_testing.db_interface import query_wdb


def clean_table(agent_id, table):
    """Delete all table entries of the agent DB using fortishield_db.
...
def insert_package(agent_id='000', scan_id=int(time()), format='rpm', name='custom-package-0',
                   priority='', section='Unspecified', size=99, vendor='fortishield-mocking', version='1.0.0-1.el7',
                   architecture='x64', multiarch='', description='Fortishield mocking packages', source='Fortishield QA tests',
