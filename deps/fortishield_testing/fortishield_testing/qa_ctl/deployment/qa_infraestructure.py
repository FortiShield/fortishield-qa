...
from fortishield_testing.qa_ctl.deployment.docker_wrapper import DockerWrapper
from fortishield_testing.qa_ctl.deployment.vagrant_wrapper import VagrantWrapper
...
class QAInfraestructure:
    ...
    """
    DOCKER_NETWORK_NAME = 'fortishield_net'
