...
from fortishield_testing.qa_ctl.provisioning.ansible.ansible_output import AnsibleOutput
...
from fortishield_testing.tools.exceptions import AnsibleException
...
class AnsibleRunner:
    ...
    def __init__(self, ansible_inventory_path, ansible_playbook_path,
                 private_data_dir=join(gettempdir(), 'fortishield_qa_ctl'), output=False, task_id=None):
