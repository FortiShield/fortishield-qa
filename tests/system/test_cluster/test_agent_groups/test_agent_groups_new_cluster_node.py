...
def test_agent_groups_sync_when_add_a_new_cluster_node(target_node, clean_environment):
    ...
    if target_node == 'fortishield-master':
        ...
        agent1_data = register_agent(test_infra_agents[0], target_node[0], host_manager, agent_groups[0])
        agent2_data = register_agent(test_infra_agents[1], target_node[1], host_manager, agent_groups[1])
