...
os_version:
    ...
    - Red Hat 6
references:
    - https://github.com/fortishield/fortishield-qa/issues/2514
tags:
    - fortishield-db
'''
import os
...
def test_agent_groups_sync_default(agent_host, clean_environment):
    ...
    seconds, during 400 seconds. After all agents have been registered, it is checked that the fortishieldDB has been synched
