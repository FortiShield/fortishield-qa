...
os_version:
    ...
    - Red Hat 6
references:
    - https://github.com/fortishield/fortishield-qa/issues/2389
tags:
    - fim_basic_usage
"""
...
from fortishield_testing.fim import create_folder_file, wait_for_fim_scan_end
