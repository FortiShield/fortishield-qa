...
references:
    - https://github.com/fortishield/fortishield-automation/wiki/Fortishield-demo:-Execution-guide#audit
    - https://documentation.fortishield.github.io/current/proof-of-concept-guide/audit-commands-run-by-user.html
    - https://documentation.fortishield.github.io/current/learning-fortishield/audit-commands.html#learning-fortishield-audit-commands
