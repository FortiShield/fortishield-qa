...
references:
    ...
    - https://fortishield.github.io/documentation/current/proof-of-concept-guide/audit-commands-run-by-user.html
    - https://fortishield.github.io/documentation/current/learning-fortishield/audit-commands.html#learning-fortishield-audit-commands
