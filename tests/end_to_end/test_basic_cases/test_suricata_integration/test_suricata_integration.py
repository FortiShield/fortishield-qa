...
references:
    ...
    - https://fortishield.github.io/documentation/current/proof-of-concept-guide/integrate-network-ids-suricata.html
    - https://fortishield.github.io/documentation/current/learning-fortishield/suricata.html#learning-fortishield-suricata
tags:
    - demo
    - suricata
    - nids
