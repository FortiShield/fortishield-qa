...
brief: This test will verify that the command monitoring capability to detect unauthorized processes is working
       correctly. Netcat is a computer networking utility that functions as a back-end tool that allows for port
       scanning and port listening.
...
references:
    - https://github.com/fortishield/fortishield-automation/wiki/Fortishield-demo:-Execution-guide#netcat
    - https://fortishield.github.io/documentation/current/proof-of-concept-guide/detect-unauthorized-processes-netcat.html
...
def test_unauthorized_processes_detection(configure_environment, metadata, get_indexer_credentials, get_manager_ip,
