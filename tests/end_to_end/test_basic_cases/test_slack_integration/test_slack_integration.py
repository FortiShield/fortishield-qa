...
references:
    - https://github.com/fortishield/fortishield-automation/wiki/Fortishield-demo:-Execution-guide#slack
    - https://fortishield.github.io/documentation/current/proof-of-concept-guide/poc-integrate-slack.html
tags:
    - demo
    - slack
    - integration
...
@pytest.mark.skip(reason='https://github.com/fortishield/fortishield-qa/issues/3286')
