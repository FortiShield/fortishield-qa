...
references:
    - https://github.com/fortishield/fortishield-automation/wiki/Fortishield-demo:-Execution-guide#ip_reputation
    - https://fortishield.github.io/documentation/current/proof-of-concept-guide/block-malicious-actor-ip-reputation.html
tags:
    - demo
    - ip_reputation
    - lists
...
from fortishield_testing.modules import TIER0, LINUX, WINDOWS
...
def test_ip_reputation(configure_environment, metadata, get_indexer_credentials, get_manager_ip, generate_events,
                       clean_alerts_index):
    '''
