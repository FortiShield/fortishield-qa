...
references:
    ...
    - https://documentation.fortishield.github.io/current/proof-of-concept-guide/poc-file-integrity-monitoring.html
...
test_cases_file_path = os.path.join(test_data_path, 'test_cases', 'cases_fim_windows.yaml')
