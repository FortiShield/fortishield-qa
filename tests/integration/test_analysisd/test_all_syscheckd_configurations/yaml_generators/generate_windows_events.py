...
from fortishield_testing.fim import REGULAR, create_file, modify_file, delete_file, callback_detect_event
from fortishield_testing.tools import FORTISHIELD_CONF, PREFIX, LOG_FILE_PATH
...
def configure_syscheck_environment(time_sleep):
    ...
    try:
        while True:
            fortishield_log_monitor.start(timeout=5, callback=callback_detect_event)
    except TimeoutError:
        pass
