...
references:
    - https://fortishield.github.io/documentation/current/user-manual/reference/daemons/fortishield-authd.html
    - https://fortishield.github.io/documentation/current/user-manual/registering/host-verification-registration.html
