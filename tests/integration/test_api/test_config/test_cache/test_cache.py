...
references:
    ...
    - https://fortishield.github.io/documentation/current/user-manual/api/configuration.html#cache
...
import pytest
import requests
from fortishield_testing.fim import create_file, delete_file, REGULAR, FORTISHIELD_PATH
...
rules_directory = os.path.join(FORTISHIELD_PATH, 'ruleset', 'rules')
