...
from fortishield_testing.fortishield_db import query_wdb, insert_agent_in_db
...
def test_set_agent_groups(remove_database, restart_fortishield_daemon, test_case, create_groups):
    '''
    description: Check that every input message using the 'set_agent_groups' command in fortishield-db socket generates
    ...
    parameters:
        ...
        - restart_fortishield:
            type: fixture
            brief: Reset the 'ossec.log' file and restart Fortishield.
        - test_case:
            type: fixture
