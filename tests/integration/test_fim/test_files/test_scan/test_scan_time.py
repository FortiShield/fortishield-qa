...
brief: File Integrity Monitoring (FIM) system watches selected files and triggering alerts when these
       files are modified. Specifically, these tests will check if the 'fortishield-syscheckd' daemon runs
...
def test_scan_time(tags_to_apply,
    ...
    '''
    description: Check if the 'fortishield-syscheckd' performs a scan at the time of day specified in
    ...
    input_description: A test case (scan_time) is contained in external YAML file (fortishield_conf.yaml) which
