...
import pytest
from fortishield_testing import T_30, LOG_FILE_PATH
...
def test_tags(folder, name, content,
    ...
    '''
    description: Check if the 'fortishield-syscheckd' daemon generates the tags required for each event
    ...
    input_description: A test case is contained in external YAML file (fortishield_conf.yaml) which
                       includes configuration settings for the 'fortishield-syscheckd' daemon and,
    ...
    regular_file_cud(folder, fortishield_log_monitor, file_list=files, min_timeout=T_30,
