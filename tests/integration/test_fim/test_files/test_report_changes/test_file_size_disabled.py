...
references:
    ...
    - https://fortishield.github.io/documentation/current/user-manual/reference/ossec-conf/syscheck.html#file-size
...
from fortishield_testing.modules.fim.event_monitor import CB_FILE_SIZE_LIMIT_REACHED
...
@pytest.mark.parametrize('filename, folder, size', [('regular_0', testdir1, 1000000)])
def test_file_size_disabled(filename, folder, size, get_configuration, configure_environment,
