...
def test_file_limit_values(configure_local_internal_options_module, get_configuration, configure_environment,
                           restart_syscheckd):
    '''
    description: Check if the 'fortishield-syscheckd' daemon detects that the value of the 'entries' tag, which corresponds
    ...
    tags:
        - scheduled
    '''
    # Get the file_limit value configured from the fortishield logs
