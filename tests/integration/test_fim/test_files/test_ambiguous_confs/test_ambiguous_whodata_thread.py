...
references:
    - https://fortishield.github.io/documentation/current/user-manual/capabilities/auditing-whodata/who-linux.html
    - https://fortishield.github.io/documentation/current/user-manual/capabilities/file-integrity/index.html
    - https://fortishield.github.io/documentation/current/user-manual/reference/ossec-conf/syscheck.html
...
import pytest
from fortishield_testing import LOG_FILE_PATH, T_30
from fortishield_testing.tools import configuration, PREFIX
from fortishield_testing.tools.monitoring import FileMonitor
from fortishield_testing.modules.fim.event_monitor import detect_whodata_start
...
def test_ambiguous_whodata_thread(configuration, metadata, set_fortishield_configuration,
                                  configure_local_internal_options_function, restart_syscheck_function):
    '''
    description: Check if the 'fortishield-syscheckd' daemon starts the 'whodata' thread when the configuration
    ...
    input_description: Two test cases are contained in external YAML file (fortishield_conf_whodata_thread.yaml)
                       which includes configuration settings for the 'fortishield-syscheckd' daemon and testing
    ...
    if metadata['whodata_enabled']:
        detect_whodata_start(fortishield_log_monitor, timeout=T_30)
    else:
