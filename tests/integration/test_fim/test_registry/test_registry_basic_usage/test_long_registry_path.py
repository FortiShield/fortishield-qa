...
def test_long_registry_path(get_configuration, configure_environment, restart_syscheckd, wait_for_fim_start):
    '''
    description: Check if the 'fortishield-syscheckd' daemon generates events from monitored keys with long paths.
    ...
    registry_value_cud(key, sub_key_1, fortishield_log_monitor, arch=arch,
