...
def test_integration_no_option_tag(configuration, metadata, set_fortishield_configuration, truncate_monitored_files,
    ...
    evm.get_message_sent(integration='Slack', file_monitor=fortishield_monitor)
...
def test_slack_options(configuration, metadata, set_fortishield_configuration, truncate_monitored_files,
                       configure_local_internal_options_module, restart_fortishield_daemon_function,
                       wait_for_start_module):
    '''
    ...
    if not metadata['sends_message']:
        ...
        message = evm.get_message_sent(integration='Slack', file_monitor=fortishield_monitor)
