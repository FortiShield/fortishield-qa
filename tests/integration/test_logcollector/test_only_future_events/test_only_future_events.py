...
log_test_path = os.path.join(temp_dir, 'fortishield-testing', 'test.log')
...
def test_only_future_events(configuration, metadata, set_fortishield_configuration,
                            configure_local_internal_options_module, setup_log_monitor, get_files_list,
                            create_file_structure_module, restart_fortishield_daemon_function):
    '''
    ...
    evm.check_syslog_message(file_monitor=log_monitor, message=message,
                             error_message=GENERIC_CALLBACK_ERROR_COMMAND_MONITORING, prefix=prefix,
