...
brief: The 'fortishield-logcollector' daemon monitors configured files and commands for new log messages.
       ...
       correctly executed by the logcollector, and the Fortishield API returns the same values for
...
references:
    ...
    - https://fortishield.github.io/documentation/current/user-manual/reference/ossec-conf/localfile.html#command
    - https://fortishield.github.io/documentation/current/user-manual/reference/ossec-conf/localfile.html#alias
...
def test_configuration_command(configure_local_internal_options_module, get_configuration,
    ...
    '''
    description: Check if the 'fortishield-logcollector' daemon can monitor commands that use multiple parameters.
