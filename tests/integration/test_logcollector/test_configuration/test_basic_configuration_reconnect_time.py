...
def check_configuration_reconnect_time_valid():
    """Check if Fortishield module correctly runs and analyzes the desired eventchannel.
...
def check_configuration_reconnect_time_invalid(cfg):
    """Check if Fortishield fails due to a invalid reconnect time attribute configuration value.
...
def test_configuration_reconnect_time(get_configuration, configure_environment):
    '''
    description: Check if the 'fortishield-logcollector' daemon detects invalid settings for the 'reconnect_time' tag.
