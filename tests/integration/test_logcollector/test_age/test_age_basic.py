...
@pytest.mark.xfail(reason='Expected error. Issue https://github.com/fortishield/fortishield/issues/8438')
def test_configuration_age_basic(configure_local_internal_options_module, get_files_list,
    ...
    input_description: A configuration template (test_age) is contained in an external YAML file (fortishield_age.yaml),
                       which includes configuration settings for the 'fortishield-logcollector' daemon and, it is
